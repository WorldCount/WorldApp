...
namespace WorldStat.Core.PrintDocuments
{
    public class ReportPrintDocument : PrintDocument
    {
        ...
        private readonly string _dayCount;
        ...
        public ReportPrintDocument(List<Report> reports, string count, string sum, string dayCount)
        {
            _reports = reports;
            _count = count;
            _sum = sum;
        ...
        private string[] GetValuesByType(Report report)
        {
        ...
        {
            return new[] { _dayCount, "", "", _count, _sum };
        }

        /// <summary>Печать строки</summary>
        private void PrintRow(PrintPageEventArgs e, Report report, int topMargin)
        {
